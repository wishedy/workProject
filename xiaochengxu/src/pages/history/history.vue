    ...
    <section class="header">
      <section class="input-box">
        <div class="sd_searchGroup" data-alcode-mod='759'>
          <img class="search-icon" src="https://m.allinmed.cn/static/image/mp/index/serch_moren.png"
               @click.stop="cleanContent">
          <input placeholder-style="color:#999999" class="sd_searchInput" data-alcode='e174'
                 :class="{paddingShow:searchVal.length>0}" type="text" v-model.trim="searchVal"
                 placeholder="输入医院、医生、疾病关键词搜索"
                 @focus="getHistoryRecord()" focus=true>
