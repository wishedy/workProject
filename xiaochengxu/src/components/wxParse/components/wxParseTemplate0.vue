<template>
  ...
  <block v-if="node.node == 'element'">
    ...
    <block v-else-if="node.tag == 'video'">
      <wx-parse-video :node="node" v-if="!android" />
      <wxParseVideoAndroid :node="node" v-if="android"></wxParseVideoAndroid>
...
<script>
  ...
  import wxParseVideoAndroid from "./wxParseVideoAndroid";
  export default {
