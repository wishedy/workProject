...
function ckcpt() {
    var cpt = '';
    cpt += 'right.swf,2,1,0,1,2,0|'; //右边开关灯，调整，分享按钮的插件
...
function ckstyle() { //定义总的风格
    var ck = {
		...
		*/
		...
		以下是播放器自带的二个插件
		*/
        control_rel: 'related.swf,//www.allinmd.cn/plugins/ckplayer63/ckplayer/related.xml,0',
        /*
		视频结束显示精彩视频的插件
...
//      advmarquee: escape('{a href="http://www.ckplayer.com"}{font color="#FFFFFF" size="12"}这里可以放文字广告，播放器默认使用这里设置的广告内容，如果不想在这里使用可以清空这里的内容，如果想在页面中实时定义滚动文字广告内容，可以清空这里的内容，然后在页面中设置广告函数。{/font}{/a}'),
		...
		*/
        cpt_share: '0',//ckplayer/share.xml
        /*
		分享插件调用的配置文件地址
		调用插件开始
		*/
