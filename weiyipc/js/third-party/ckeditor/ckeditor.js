...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = {
            ...
            getUrl: function (b) {
                ...
                -1 == b.indexOf(":/") && 0 !== b.indexOf("/") && (b = "//www.allinmd.cn/js/third-party/ckeditor/" + b);
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, e) {
            ...
            table: 1,
            ul: 1
        }, i = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, g = {}, l = {"#": 1}, h = {
            center: 1,
            dir: 1,
            noframes: 1
        };
    ...
    (function () {
        ...
        function c(b) {
            ...
            return b._.filterFunction = function (f, d, j, i, m, n, t) {
                ...
                if (d) {
                    var g = f.name, j = d.elements[g], l = d.generic, d = {
        ...
        var G = {styles: 1, attributes: 1, classes: 1}, I = {
            styles: "requiredStyles",
            attributes: "requiredAttributes",
            classes: "requiredClasses"
        }, B = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, N = {
            styles: /{([^}]+)}/,
            attrs: /\[([^\]]+)\]/,
            classes: /\(([^\)]+)\)/
    ...
    (function () {
        ...
        var y = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}",
            m = CKEDITOR.dtd, j = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], n = CKEDITOR.tools.extend({}, m.$blockLimit, m.$block), r = {
                elements: {
                    input: l,
                    textarea: l
                }
            }, J = {attributeNames: [[/^on/, "data-cke-pa-on"], [/^data-cke-expando$/, ""]]}, t = {
                elements: {
                    embed: function (a) {
                        var b = a.parent;
                        if (b && b.name == "object") {
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, l = a.elementMode,
                h = a.fire("uiSpace", {space: "top", html: ""}).html, k = a.fire("uiSpace", {
                    space: "bottom",
                    html: ""
                }).html;
    ...
    (function () {
        ...
        var q = function () {
            ...
            var n = CKEDITOR.dtd, i = {
                p: 1, div: 1,
                h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1
            }, g = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, t = CKEDITOR.tools.extend({}, n.$inline);
            delete t.br;
            return function (i, h, k) {
                ...
                if (!o.checkReadOnly()) {
                    var v = (new CKEDITOR.dom.elementPath(o.startContainer, o.root)).blockLimit || o.root, h = {
                            type: h,
                            dontFilter: q,
                            editable: i,
                            editor: r,
                    ...
                    if (x = k) {
                        ...
                        k = h.editor.dataProcessor.toHtml(k, {
                            context: null, fixForBody: false, dontFilter: h.dontFilter, filter: h.editor.activeFilter,
    ...
    (function () {
        ...
        var J = {
            ...
            audio: 1,
            video: 1
        }, w = /\s*(?:;\s*|$)/, G = /#\((.+?)\)/g, I = CKEDITOR.dom.walker.bookmark(0, 1), B = CKEDITOR.dom.walker.whitespaces(1);
