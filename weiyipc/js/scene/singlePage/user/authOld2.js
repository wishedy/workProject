...
$(function () {
    ...
    newAuth = {
        ...
        firstAuthStep: function () {
            ...
            setTimeout(function(){
                g_sps&&g_sps.createBrowse({pageId:436});
            },2200);
            var t = this;
                        ...
                        callback: function () {
                            if (document.referrer) {
                                ...
                                if (
                                    ...
                                    if(href.lastIndexOf("?from=emr")>-1){
                                        g_sps.jump(null, "/");
                                    }else{
                                        history.go(-1);
                                    }
        ...
        secondAuthStep: function () {
            ...
            setTimeout(function(){
                g_sps&&g_sps.createBrowse({pageId:438});
            },2200);
            t.browType = 10014;
            $("#firstStep").hide();
            $("#secondStep").show();
                                    ...
                                    roleConfigsStr += ' <section class="ev-attType ev-imgAtt' + (refId == 10 ? (t.medicalID == '10' ? 12 : 11) : refId) + '">' +
                                        ...
                                        (function () {
                                            ...
                                            if(
                                                ...
                                                switch (refId){
                                                    case 9:
                                                        str='<span class="only onlyTip">仅上传学历证无法完成认证</span>';
                                                        break;
                                                    case 7:
                                                        str='<span class="only onlyTip">仅上传学位证无法完成认证</span>';
                                                        break;
                                                }
                                            }
                                            return str;
            ...
            var str = '<section class="ev-attType ev-imgAtt' + option.refId + '">' +
                ...
                (function () {
                    ...
                    switch (option.refId){
                        ...
                        case 8://执业
                        // case 6://资格
                            str='<span class="only onlyTipRed">需包含必要信息页：基本信息页和变更信息页</span>';
                            break;
                    }
                    return str;
                }()) +
                ...
                '                                <div class="sample">' + ((option.refId == 6 || option.refId == 8) ? ( option.refId == 8? '基础页+照片页示例':'第一页示例') : '示例') + '</div>' +
                '                            </figure>' +
                '                            <!--上传后的图片 上传中添加类名 uploading-->' +
                '                            <figure class="uploadSuccess cer_upload">' +
                '                                <div class="czyx1">' +
                ...
                (function () {
                    ...
                    if (option.refId == 6 || option.refId == 8 || option.refId == 1) {
                        str = '<aside class="uploadImg ev-cerUploadCon">' +
                            '        <input type="hidden" value="" name="certificatesPath" class="certificatesPath" />' +
                            '         <div class="photoCont">' +
                            '             <figure><img src="/images/img10/authentication/certificate/' + option.demoImg[option.refId][1] + '"><div class="sample">' + ((option.refId == 6 || option.refId == 8) ? ( option.refId == 8? '信息页+变更页示例':'第二页示例') : '示例') + '</div></figure>' +
                            '             <!--上传后的图片 上传中添加类名 uploading-->' +
                            '             <figure class="uploadSuccess cer_upload">' +
                            '                 <div class="czyx1">' +
                            '                     <div class="ev-upload hide">' +
