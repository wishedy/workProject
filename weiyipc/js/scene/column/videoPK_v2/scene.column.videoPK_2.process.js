...
module.videoCasePk2=function(obj){
                        ...
                        user.login({
                            callback:function(){
                                        ...
                                        success : function(rep){
                                            if(rep.responseObject.responseData){
                                                ...
                                                if(num==1){//没有报名
                                                    ...
                                                    if($(".nav_apply a").length){$(".nav_apply a").text("立即报名");}
                                                }else if(num>=2){//报过名
                                                    if($('#activityId').length){$('#activityId').attr('registerStatus',num);}
                                                    if($(".nav_apply a").length){$(".nav_apply a").text("立即上传");}
                                                }
                                            }
                                        }
                                    });
                                ...
                                if($("#activityId").attr("expert")==1){
                                    $(".nav_zx_a").text("作品审核");
                                    $(".nav_apply").remove();
                                    if($('.naver_lists').length){$('.naver_lists').show();}
