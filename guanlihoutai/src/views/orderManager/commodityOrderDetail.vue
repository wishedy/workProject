    ...
    getDetailData() {
      ...
      axios({
        ...
        if (res && res.data && res.data.responseObject && res.data.responseObject.responseData) {
          ...
          this.formData.totalAmount = '￥' + _orderDetailResult.totalAmount;
          this.formData.payAmount = '￥' + _orderDetailResult.payAmount;
          ...
          if (this.formData.orderType === 1) {
            ...
            this.formData.couponAmount = '￥' + _orderDetailResult.couponAmount;
          }// 兑换码订单
            ...
            this.formData.thirdPartSerialNumber = '-';
            this.formData.isExistRefundOrderName = '-';
          }
