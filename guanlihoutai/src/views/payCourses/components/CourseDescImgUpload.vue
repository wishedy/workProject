<template>
  <section class="course-desc-img-upload">
...
/**
   * 课程详情-简介图片上传
   * @module '@/views/payCourses/components/CourseDescImgUpload'
   * @desc  课程详情的简介部分通用图片上传组件
   * @author 刘宇涛
   * @date 2019-5-10
   * @param 详见 props
   * @example
   *       <CourseDescPicImgUpload
