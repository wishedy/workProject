  ...
  <section class="creat-main-contains">
    ...
    <el-form ref="couponForm"
      ...
      <el-form-item label="优惠券描述" prop="displayName">
        ...
        <p class="input-after-tip">展示在付费视频和课程页领取区域中，文案中涉及金额需与该优惠券金额保持一致，请谨慎操作</p>
      </el-form-item>
