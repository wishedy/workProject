...
(function( $, undefined ) {
		...
		$.mobile.path = path = {
			...
			isRelativeUrl: function( url ) {
				// All relative Url variants have one thing in comm, no protocol.
...
(function( $, undefined ) {
	...
	base = {
		...
		// define base element, for use in routing assest urls that are referenced
...
$.widget( "mobile.checkboxradio", $.extend( {
	...
	_handleLabelVClick: function( event ) {
		...
		// Input set for comm radio buttons will contain all the radio
