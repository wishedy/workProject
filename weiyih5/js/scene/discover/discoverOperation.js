...
$(function() {
    ...
    DiscoverPrepuce.prototype = {
        init: function() {
            var that = this;
            //Log.createBrowse(46, '按术式');
            this.backBtn();
            this.layout();
            this.getFilterItem();
            this.getContentList({
        ...
        layout: function() {
            ...
            $(".al-twoFloorSecondFilter").on("click", ".al-twoFloorSecondFilterItem", function(e) {
                ...
                $('.EV-discoverPrepuceFilter').children().remove();
        ...
        contentGenerate: function(ele) {
            ...
            cTemplate = ' <section class="al-contentPartModule">' +t.scoreDom(ele.currentStarLevel,ele.currentScoreNum)+
                ...
                '</section>' +
                '</section>';
            $(".EV-discoverPrepuceFilter").append(cTemplate);
        ...
        dataWaterfall: function(rObj) {
            ...
            $('.EV-discoverPrepuceFilter').off("scroll").scrollPagination({
                ...
                'loader': function(res) {
                    if ($.isEmptyObject(res)) {
                        $(".EV-discoverPrepuceFilter").attr('scrollPagination', 'disabled');
                        return false;
                    } else {
    ...
    var discoverPrepuce = new DiscoverPrepuce();
    discoverPrepuce.init();
});
