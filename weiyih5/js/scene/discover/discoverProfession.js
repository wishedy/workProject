...
$(function() {
    var DiscoverProfession = function() {
        var that = this;
        var $that = $(this);
        this.XHRList = {
    ...
    DiscoverProfession.prototype = {
        init: function() {
            var that = this;
            //window.onload = Log.createBrowse(44, '按专业');
            this.getFilterItem();
            this.getContentList({
        ...
        layout: function() {
            ...
            $(".EV-discoverProfessionFilter").css("marginTop", fH);
            ...
            $(".al-twoFloorSecondFilter").on("click", ".al-twoFloorSecondFilterItem", function(e) {
                ...
                $(".EV-discoverProfessionFilter").children().remove();
        ...
        getContentList: function(rObj) {
            ...
            var data = {
                ...
                pageIndex: 1,
                pageSize: 20,
                dataScene: rObj.dataScene,
                dataType: rObj.dataType,
                scene: 2,
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    if (typeof(data.responseObject.responseData.data_list) !== 'undefined' && data.responseObject.responseData.data_list.length !== 0) {
        ...
        contentGenerate: function(ele) {
            ...
            cTemplate = ' <section class="al-contentPartModule">' +t.scoreDom(ele.currentStarLevel,ele.currentScoreNum)+
                ...
                '</section>' +
                '</section>';
            $(".EV-discoverProfessionFilter").append(cTemplate);
        },
        getFilterItem: function() {
            ...
            $.ajax({
                ...
                .done(function(data) {
                    if(data&&data.responseObject&&data.responseObject.responseData&&data.responseObject.responseData.data_list&&data.responseObject.responseData.data_list.length) {
        ...
        dataWaterfall: function(rObj) {
            ...
            $('.EV-discoverProfessionFilter').off("scroll").scrollPagination({
                ...
                'loader': function(res) {
                    ...
                    if ($.isEmptyObject(res)) {
                        ...
                        $(".EV-discoverProfessionFilter").attr('scrollPagination', 'disabled');
                        return false;
                    } else {
    ...
    var discoverProfession = new DiscoverProfession();
    discoverProfession.init();
});
