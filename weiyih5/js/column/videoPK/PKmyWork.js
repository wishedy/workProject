...
$(function(){
    ...
    /*$.ajax({
        type : "post",
        url : "/mcall/cms/activity/getActivityMapList/",
        async:false,
        dataType : "json",
    ...
    data.logoUseFlag=3;
    data.customerId=appjs.getAuthorCustomerId();//1444621338819;//会员ID由app提供
            ...
            if(rep&&rep.responseObject&&rep.responseObject.responseData){
                if(rep.responseObject.responseData.data_list&&rep.responseObject.responseData.data_list.length>0){
                    ...
                    $.each(list,function(i,val){
                        var trend=val;
                        var resourceId="";
                        var resourceUrl="javascript:;";		//无效链接
                        ...
                        if(trendType==7){//病例
                            if(trend.case_attachment_list[0].attUrl){
                        ...
                        html+='<div class="list_con" resourceId="'+resourceId+'" trendType="'+trendType+'" resourceName="'+trend.customer_trends.resourceName+'">'+
                        '<div class="list_z">'+
                        '<a href="javascript:;">'+
