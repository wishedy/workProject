    ...
    spTemp_listLoad: function (ev) {
        var myList = {
            ...
            init: function () {
                ...
                $(".appPerImg,.appThemeUrl,.appVideoLive").on("click", function () {
                    var h5url = $(this).attr("h5url");
                    if (h5url) {
                      g_sps.jump(null,h5url);
                    }
                })
            },
            ...
            themeNewsHtml: function (data) {
                ...
                //新闻专家列表展开更多操作
                $(".ev-openMore").off("click").on("click", function (e) {
            ...
            doctorList:function(){
                ...
                if($('.theme_news').length>0 && $('.teacherIntroduction').length>0){
                    if($('.teacherIntroduction').hasClass('nav1')){
                        t.getDoctorsFn(1);//关节&运动医学疾病
                    }else if($('.teacherIntroduction').hasClass('nav2')){
                        t.getDoctorsFn(2);//创伤&足踝疾病
                    }else{
                        t.getDoctorsFn(3);//脊柱&骨肿瘤疾病
                    }
                }
            },
            //通过参数获取医师列表
                                        ...
                                        if(data.doctorList[leve] && data.doctorList[leve].areaList && data.doctorList[leve].areaList.dataList && data.doctorList[leve].areaList.dataList[areaIndex].docDataList){
                                            ...
                                            for(var n in dataList){
                                                if(dataList.length>0 && n<dataList.length){
                                                    ...
                                                    docHtml += '<li class="doctorItem" data-jumpUrl="'+(dataList[n].teamBgImg?'/pages/column/activityTemplate/activity_teamDesc.html?leve='+leve+'&areaLeve='+areaIndex+'&docLeve='+n:'javascript:;')+'">' +
                                                        '                                    <div class="doctorPic">' +
            ...
            resourceListHtml: function (data) {
                ...
                if (moduleItem && moduleItem.length > 0) {
                    for (var j = 0; j < moduleItem.length; j++) {
                        ...
                        if (listItem.coverPicUrl) {
                            ...
                            resourceListHtml += '<section class="spTemp_list_resource case_content res_list_border">' +
                                ...
                                '<section class="al-actListTitleBox"><h3 class="spTemp_list_resource_title"><a href="' + (listItem.h5Url?listItem.h5Url:'javascript:;') + '">' + ((item.isShowArea == 1 && listItem.resourceForArea) ? '<span class="al-actAreaColor">【' + listItem.resourceForArea + '】</span>' + comm.getStrLen(listItem.title, 30) : comm.getStrLen(listItem.title, 40)) + '</a></h3>' +
                                '<p class="act_list_type">' + act_type_res +
                                '<span>' + (name?comm.getStrLen(name, manyAuthor?30:10):"" )+ '</span>' +
                                '<span '+(manyAuthor?'style="display:none"':'')+'>' + (listItem.hospitalName ? comm.getStrLen(listItem.hospitalName, 16) : "") + '</span>' +
                                ...
                                '<a href="' + (listItem.h5Url?listItem.h5Url:'javascript:;') + '"><img src="' + listItem.coverPicUrl + '">' + videoBtn + promoteFlag + '</a>' +
                                video_play_time +
                            ...
                            resourceListHtml += '<section class="spTemp_list_resource case_content res_list_border">' + promoteFlag +
                                '<h3 class="spTemp_list_resource_title"><a href="' + (listItem.h5Url?listItem.h5Url:'javascript:;') + '">' + ((item.isShowArea == 1 && listItem.resourceForArea) ? '<span class="al-actAreaColor">【' + listItem.resourceForArea + '】</span>' + comm.getStrLen(listItem.title, 40) : comm.getStrLen(listItem.title, 50)) + '</a></h3>' +
                ...
                if ($('.sp_container_l div[data-id=' + dataId + ']').length && aa == 1) {
                    if (item.isShowMore && item.isShowMore == 1) {
                        resourceListHtml = resourceListHtml + '<div class="checkMore"><p><a href="javascript:;" h5url="' + item.moreWebUrl + '">查看更多</a></p></div>';
            ...
            vipListHtml: function (data) {
                ...
                if (moduleItem && moduleItem.length > 0) {
                    for (var j = 0; j < moduleItem.length; j++) {
                        ...
                        vipListHtml += '<section class="spTemp_list_member">' +
                            '<section class="spTemp_list_member_left spTemp_left"><a href="/dist/personal/others_index.html?cid=' + refId + '"><img src="' + listItem.coverPicUrl + '"></a></section>' +
                            '<section class="spTemp_list_member_center spTemp_left">' +
                            '<a href="/dist/personal/others_index.html?cid=' + refId + '"><h3 class="spTemp_list_member_title">' + (listItem.title ? comm.getStrLen(listItem.title, 26) : "") + '</h3></a>' +
                ...
                if ($('.sp_container_l div[data-id=' + dataId + ']') && aa == 2) {
                    if (item.isShowMore && item.isShowMore == 1) {
                        vipListHtml = vipListHtml + '<div class="checkMore"><p><a href="javascript:;" h5url="' + item.moreWebUrl + '">查看更多</a></p></div>';
                    } else if (item.isPage == 1 && parseInt(item.pageNum) < parseInt(item.totalCount)) { //判断是否有分页，添加展开更多DOM及事件
                        //创建专题列表请求分页时的起始页
                        var vipPage = 2;
                        //创建展开更多DOM
            ...
            rankListHtml: function (data) {
                ...
                if (moduleItem && moduleItem.length > 0) {
                    for (var k = 0; k < moduleItem.length; k++) {
                        ...
                        //判断会员排行榜2  资源排行榜1
                        if (aa == 3 && bb == 2) {
                            rankListHtml += '<div class="expert_content">' +
                                '<p class="' + (rankNum < 4 ? 'num' : 'num_1') + '"><span>' + rankNum + '</span></p>' +
                                '<div class="expert_info">' +
                                '<p class="pic"><a href="/dist/personal/others_index.html?cid=' + refId + '"><img src="' + compItem.coverPicUrl + '"></a></p>' +
                                '<div class="expert_info_cont">' +
                                '<p class="expert_name"><a href="/dist/personal/others_index.html?cid=' + refId + '" class="name">' + compItem.title + '</a>' + (rankNum < 4 ? '<i class="vipUser"></i>' : "") + '</p>' +
                        ...
                        var _contextNum = compItem.coverPicUrl ? comm.getStrLen(compItem.title, 30) : comm.getStrLen(compItem.title, 50);
                        var promoteFlag = "";
                        ...
                        if (aa == 3 && bb == 1) {
                            ...
                            if (compItem.coverPicUrl) {//resPic图片展示 _divClass外层class不同三种情况的 _downList点赞条社交操作  _numIcon排行榜排名
                                ...
                                if (_thisDiv.hasClass("resource_rank_leftImg_rightArt")) {//左图右文
                                    rankListHtml += '<div class="case_content rank_list_border' + (item.isShowSort == 0 ? ' case_content_noNum' : '') + ' ">' +
                                        '<div class="case_cont_left spTemp_right">' +
                                        '<section class="al-actListTitleBox">' +
                                        '<p class="title">' +
                                        '<a href="' + (compItem.h5Url?compItem.h5Url:'javascript:;') + '">' +
                                        ...
                                        '<span>' + (name?comm.getStrLen(name, manyAuthor?30:10):"") + '</span>' +
                                        '<span '+(manyAuthor?'style="display: none"':'')+'>' + (compItem.hospitalName ? comm.getStrLen(compItem.hospitalName, 16) : "") + '</span></p></section>' +
                                        '<section class="activityPraise">' +
                                        '<ul>' + res_socialNum + '</ul>' +
                                        '</section></div>' +
                                    ...
                                    rankListHtml += '<div class="case_content rank_list_border' + (item.isShowSort == 0 ? ' case_content_noNum' : '') + ' ">' +
                                        ...
                                        _numIcon +
                                        '<section class="al-actListTitleBox"><p class="title"><a href="' + (compItem.h5Url?compItem.h5Url:'javascript:;') + '">'
                                        + ((item.isShowArea == 1 && compItem.resourceForArea) ? '<span class="al-actAreaColor">【' + compItem.resourceForArea + '】</span>' + _contextNum : _contextNum) +
                                        '</a></p>' +
                                        '<p class="act_list_type">' + res_type + '<span>' + (name?comm.getStrLen(name, manyAuthor?30:10):"") + '</span>' +
                                        '<span '+(manyAuthor?'style="display: none"':'')+'>' + (compItem.hospitalName ? comm.getStrLen(compItem.hospitalName, 16) : "") + '</span></p></section>' +
                                        '<ul>' + res_socialNum + '</ul></div><p class="case_cont_right spTemp_right">' +
                                        '<a href="' + (compItem.h5Url?compItem.h5Url:'javascript:;') + '"><img class="bg" src="' + compItem.coverPicUrl.split('|')[0] + '">' + _vPlayBtn + promoteFlag + '</a>'
                                        + _vTimeBtn + '</p></div></div>';
                                }
                            } else {//没有图
                                var _flagClass = "";//排行榜
                                ...
                                rankListHtml += '<div class="case_content rank_list_border' + (item.isShowSort == 0 ? ' case_content_noNum' : '') + ' ">' + promoteFlag +
                                    '<div class="act_case_cont spTemp_left">' +
                                    _numIcon +
                                    '<p class="title ' + _flagClass + '"><a href="' +(compItem.h5Url?compItem.h5Url:'javascript:;') + '">'
                                    ...
                                    '<p class="act_list_type">' + res_type + '<span>' + (name?comm.getStrLen(name, manyAuthor?30:10):"") + '</span>' +
                                    '<span '+(manyAuthor?'style="display: none"':'')+'>' + (compItem.hospitalName ? comm.getStrLen(compItem.hospitalName, 16) : "") + '</span></p>' +
                ...
                if ($('.sp_container_l div[data-id=' + dataId + ']') && bb == 1) {
                    if (item.isShowMore && item.isShowMore == 1) {
                        rankListHtml = rankListHtml + '<div class="checkMore"><p><a href="javascript:;" h5url="' + item.moreWebUrl + '">查看更多</a></p></div>';
                    } else if (item.isPage == 1 && parseInt(item.pageNum) < parseInt(item.totalCount)) { //判断是否有分页，添加展开更多DOM及事件
                        //创建病例排行列表请求分页时的起始页
                ...
                if (moduleItem && moduleItem.length > 0) {
                    ...
                    for (var j = 0; j < moduleItem.length; j++) {
                        ...
                        if (moduleItem.length == 1) {
                            ...
                            posidListHtml += '<a href="' + (listItem.h5Url?listItem.h5Url:'javascript:;') + '" class="recommend_intro2_content" target=' + (/allinmd/.test(listItem.h5Url) ? "_self" : "_blank") + '>' +
                                '<dl>' +
                            ...
                            posidListHtml += '<a href="' + (listItem.h5Url?listItem.h5Url:'javascript:;') + '" class="recommend_intro3_content" target=' + (/allinmd/.test(listItem.h5Url) ? "_self" : "_blank") + '>' +
                                '<dl>' +
                                '<dt><img class="bg" src="' + listItem.coverPicUrl + '" alt="">' + videoBtn_big + '<i class="label"><img src="' + listItem.logoPicUrl + '"></i>' + video_play_time + '</dt>' +
                                '<dd>' + (listItem.title ? comm.getStrLen(listItem.title, 30) : "") + '</dd>' +
                                '</dl>' +
                ...
                if (moduleItem && moduleItem.length > 0) {
                    for (var j = 0; j < moduleItem.length; j++) {
                        ...
                        if ((resouTyp == 4 && listItem.coverPicUrl) || (resouTyp == 1 || resouTyp == 7)) {//文库默认无图
                            ...
                            screeningListHtml += '<section class="spTemp_list_resource case_content scr_list_border">' +
                                '<section class="spTemp_list_resource_left ' + ($("div[data-id=" + dataId + "] .resource_list").hasClass("resource_list_leftImg_rightArt") ? "spTemp_right" : "spTemp_left") + '">' +
                                '<section class="al-actListTitleBox"><h3 class="spTemp_list_resource_title"><a href="' + (listItem.h5Url?listItem.h5Url:'javascript:;') + '">' + ((item.isShowArea == 1 && listItem.resourceForArea) ? '<span class="al-actAreaColor">【' + listItem.resourceForArea + '】</span>' + comm.getStrLen(listItem.title, 30) : comm.getStrLen(listItem.title, 40)) + '</a></h3>' +
                                '<p class="act_list_type">' + act_type_res +
                                '<span>' + (name?comm.getStrLen(name, manyAuthor?30:10):"") + '</span>' +
                                ...
                                '<section class="spTemp_list_resource_right ' + ($("div[data-id=" + dataId + "] .resource_list").hasClass("resource_list_leftImg_rightArt") ? "spTemp_left" : "spTemp_right") + '">' +
                                '<div class="spTemp_list_resource_imgBox">' +
                                '<a href="' + (listItem.h5Url?listItem.h5Url:'javascript:;') + '"><img src="' + coverPicUrl + '">' + videoBtn + promoteFlag + '</a>' +
                                video_play_time +
                                ($("div[data-id=" + dataId + "] .resource_list").hasClass("resource_list_leftImg_rightArt") ? '' : '<div class="praiseCont">' + preferUpOrScore + '</div>') +
                                '</div>' +
                                '</section>' +
                            ...
                            screeningListHtml += '<section class="spTemp_list_resource case_content scr_list_border">' +
                                ...
                                act_type_res +
                                '<span>' + (name?comm.getStrLen(name, manyAuthor?30:10):"") + '</span>' +
                                '<span '+(manyAuthor?'style="display:none"':'')+'>' + (listItem.hospitalName ? comm.getStrLen(listItem.hospitalName, 16) : "") + '</span></p>' +
