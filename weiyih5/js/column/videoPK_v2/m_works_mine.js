            ...
            if(rep&&rep.responseObject&&rep.responseObject.responseData){
                if(rep.responseObject.responseData.data_list&&rep.responseObject.responseData.data_list.length>0){
                    ...
                    $.each(list,function(i,val){
                        ...
                        html+='<section class="mine_main_cont_piece" '+($('#activityId').attr('isReviewBegin')==1?hide:"")+' resourceUrl="'+resourceUrl+'" trendType="'+trendType+'" resourceName="'+trend.customer_trends.resourceName+'">'+
