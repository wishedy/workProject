    ...
    spTemp_listLoad: function(ev) {
        var myList = {
            ...
            init: function() {
                ...
                t.videoMore();
                t.checkEndTime();
                $(".appPerImg,.appThemeUrl,.appVideoLive").off("click").on("click",function(){
            ...
            resourceListHtml: function(data) {
                ...
                if(item.isShowMore) {
                    ...
                    if(isShowMore == 1) {
                        ...
                        $('div[data-id=' + dataId + '] .total_title').children('a').attr('href', '' + item.moreWebUrl + '')
                    } else {
                ...
                if(moduleItem && moduleItem.length > 0) {
                    for(var j = 0; j < moduleItem.length; j++) {
                        ...
                        if(listItem.coverPicUrl) {
                            resourceListHtml += '<section class="spTemp_list_resource">'+
                                ...
                                '<h3 class="spTemp_list_resource_title"><a href="'+listItem.h5Url+'">'+comm.getStrLen(listItem.title,38)+'</a>'+preferUp+'</h3>'+
                                '<ul>'+
                                ...
                                '<a href="'+listItem.h5Url+'"><img src="'+listItem.coverPicUrl+'">'+videoBtn+'</a>'+
                                video_play_time+
                                '</div>'+
                                '</section>'+
                ...
                if(moduleItem && moduleItem.length > 0) {
                    for(var j = 0; j < moduleItem.length; j++) {
                        ...
                        vipListHtml += '<section class="spTemp_list_member">'+
                            ...
                            '<a href="/dist/personal/others_index.html?cid='+refId+'"><h3 class="spTemp_list_member_title">'+(listItem.title?comm.getStrLen(listItem.title,10):"")+'</h3></a>'+
                    ...
                    for(var j = 0; j < moduleItem.length; j++) {
                        ...
                        if($('div[data-id='+data.dataId+']').find(".special_list").hasClass("special_list_topImg_bottomArt")) {
                            specialListHtml +=  '<section class="spTemp_list_topic">'+
                                ...
                                '<a href="'+listItem.h5Url+'"><section class="spTemp_list_topic_fullText"><span>查看全文</span></section></a>'+
                                '</section>'
                        }else{
                            specialListHtml += '<section class="spTemp_list_topic">'+
                                '<section class="spTemp_list_topic_title">'+(listItem.summary?comm.getStrLen(listItem.summary,66):"")+'</section>'+
                ...
                if(moduleItem && moduleItem.length > 0) {
                    for(var k = 0; k < moduleItem.length; k++) {
                        ...
                        if(aa == 3 && bb == 1) {
                            ...
                            rankListHtml += '<div class="case_content">'+
                                ...
                                '<p class="title"><a href="'+compItem.h5Url+'">'+comm.getStrLen(compItem.title,38)+'</a></p>'+
                                ...
                                '<a href="'+compItem.h5Url+'"><img class="bg" src="'+resPic+'"></a>'+
            ...
            posidListHtml: function(data) {
                ...
                if(moduleItem && moduleItem.length > 0) {
                    ...
                    for(var j = 0; j < moduleItem.length; j++) {
                        ...
                        //switch(resouTyp){
                        //    case 1:
                        //        resouTypCont = '<img src="/images/img50/column/specialTemplate/resources-vedio.png">';
                        //        video_play_time = '<span class="videoTime">'+listItem.playTime+'</span>';
                        //        videoBtn_small = '<i class="btn_small"><img src="/images/img50/column/specialTemplate/play-btn-small.png"></i>';
                        //        videoBtn_big = '<i class="btn_big"><img src="/images/img50/column/specialTemplate/play-btn-small.png"></i>';
                        //        break;
                        //    case 2:
                        //        resouTypCont = '<img src="/images/img50/column/specialTemplate/resources-case.png">';
                        //        break;
                        //    case 3:
                        //        resouTypCont = '<img src="/images/img50/column/specialTemplate/resources-article.png">';
                        //        break;
                        //    case 4:
                        //        resouTypCont = '<img src="/images/img50/column/specialTemplate/resources-article.png">';
                        //        break;
                        ...
                        if(moduleItem.length == 1) {
                            ...
                            posidListHtml += '<a href="'+listItem.h5Url+'" class="recommend_intro2_content" target='+(/allinmd/.test(listItem.h5Url)?"_self":"_blank")+'>'+
                                '<dl>'+
                            ...
                            posidListHtml += '<a href="'+listItem.h5Url+'" class="recommend_intro3_content" target='+(/allinmd/.test(listItem.h5Url)?"_self":"_blank")+'>'+
                                '<dl>'+
                                '<dt><img class="bg" src="'+listItem.coverPicUrl+'" alt="">'+videoBtn_big+'<i class="label"><img src="'+listItem.logoPicUrl+'"></i>'+video_play_time+'</dt>'+
                                '<dd>'+(listItem.title?comm.getStrLen(listItem.title,32):"")+'</dd>'+
                                '</dl>'+
