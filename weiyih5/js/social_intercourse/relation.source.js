    ...
    $.fn.extend({
        "relation": function (options) {
            s = $.extend({
                ...
                nigthFileName: "/js/pages/social_intercourse/night.css",
                smallFont: 0.8, //小字体
                bigFont: 1.2, //大字体
                nullFn : false,
                //
                    ...
                    switch (s.type) {
                        case 1 : //文库
                            ...
                            if (localStorage.readSchema != undefined) {
                                ...
                                if (font == 0) {
                                    $("body").css("font-size", s.bigFont)
                                }
                                else if (font == 2) {
                                    $("body").css("font-size", s.smallFont)
                                }
                            }
                            break;
                        case 2 : //病例
                            ...
                            s.t.html(tempHtml).find("li").on("vclick",function () {
                                if(status) {
                                    ...
                                    if ($(this).attr("identity") != undefined){
                                        _this.action[$(this).attr("identity")](_this, true, this);
                                    }
                                }else{
                                    status = true;
                                    if ($(this).attr("identity") != undefined) _this.action[$(this).attr("identity")](_this, false, this);
...
//				touchcancel:系统取消touch事件的时候触发touchstart
                    ...
                    if(p.isIgnoreFontSize == false && s.isList == false){
                        if (localStorage.readSchema != undefined) {
                            ...
                            //字体
                            if (arr[1] == 0) {
                                $("body").css("font-size", arr[2] * s.bigFont + "px")
                            }
                            else if (arr[1] == 1) {
                                $("body").css("font-size", arr[2] + "px")
                            }
                            else {
                                $("body").css("font-size", arr[2] * s.smallFont + "px")
                            }
                        } else {
                            localStorage.readSchema = "0,1," + parseInt($("body").css("font-size"));
                        }
                    }
                },
                float: function () { //漂浮
                    s.t.addClass("float").addClass("user-interact-box");
                    if (s.isFloatDisappear) { //开启漂浮消失
                        $(window).on("scroll", function () {
                            var float = $("#float");
                            if ($(window).scrollTop() > ($(p.disappearPlace).offset().top - $(window).height())) {
                                float.removeClass("float").removeClass("user-interact-box");
                            } else {
                                if (float.attr("class").indexOf("float") == -1) float.addClass("float").addClass("user-interact-box");
                            }
                ...
                templateLibrary: {
                    ...
                    ////缺个设置的图片
                    //a: "<ul>" +
                    //"<li identity=\"share\"><img src=\"//img50.allinmd.cn/case/fx_blue.png\" /><>分享</li>" +
                    //"<li identity=\"praise\"><img src=\"//img50.allinmd.cn/case/praise_blue.png\" />赞</li>" +
                    //"<li identity=\"collect\"><img src=\"//img50.allinmd.cn/case/zan_blue.png\" />收藏</li>" +
                    //"<li identity=\"docSet\"><img src=\"//img50.allinmd.cn/case/set_blue.png\" />设置</li>" +
                    //"</ul>",
                    //b1: "<ul>" +
                    //"<li id=\"anchor\"><img src=\"//img50.allinmd.cn/case/hf_blue.png\">回复</li>" +
                    //"<li identity=\"share\"><img src=\"//img50.allinmd.cn/case/fx_blue.png\">分享</li>" +
                    //"<li identity=\"collect\"><img src=\"//img50.allinmd.cn/case/zan_blue.png\">收藏</li>" +
                    //"<li identity=\"praise\"><img src=\"//img50.allinmd.cn/case/praise_blue.png\">赞</li>" +
                    //"</ul>",
                    ...
                    //"<li identity=\"share\"><img src=\"//img50.allinmd.cn/case/fx_img.png\" />分享</li>" +
                    ...
                    //"<li identity=\"share\"><img src=\"//img50.allinmd.cn/case/fx_blue.png\">分享</li>" +
                    //"<li identity=\"collect\"><img src=\"//img50.allinmd.cn/case/zan_blue.png\">收藏</li>" +
                    //"<li identity=\"more\"><img src=\"//img50.allinmd.cn/case/more_blue.png\"></li>" +
                    //"</ul>",
                    //b21: "<ul>" +
                    //"<li id=\"anchor\"><img src=\"//img50.allinmd.cn/case/hf_img.png\" />回复</li>" +
                    //"<li identity=\"share\"><img src=\"//img50.allinmd.cn/case/fx_img.png\" />分享</li>" +
                    //"<li identity=\"collect\" coloring=\"no\"><img src=\"//img50.allinmd.cn/case/sc_img.png\" />收藏</li>" +
                    //"<li identity=\"more\"><img src=\"//img50.allinmd.cn/case/gdd.png\" /></li>" +
                    //"</ul>",
                    a: "<ul>" +
                    ...
                    b2: "<ul>" +
                        ...
                        "</ul>",
                    b21: "<ul>" +
                        "<li id=\"anchor\"><img style=\"width:200%\" src=\"//img50.allinmd.cn/case/f-default-reply.png\"></li>" +
                        "<li identity=\"praise\"><img style=\"width:200%\" src=\"//img50.allinmd.cn/case/f-default-praise.png\"></li>" +
                        "<li identity=\"collect\"><img style=\"width:200%\" src=\"//img50.allinmd.cn/case/f-default-collect.png\"></li>" +
                        "<li style=\"border-right:none\" identity=\"share\"><img style=\"width:200%\" src=\"//img50.allinmd.cn/case/f-default-share.png\"></li>" +
                        "</ul>",
                ...
                action: { //事件
                    chat: function (t, useless, _this) {
                        ...
                        $("#watchMe").live("vclick", function () {
                            ...
                            $.each(dataJson, function (i, el) {
                                ...
                                html += "<li style=\"padding: 2em 1.25em 0em 1.25em\">" + $(t.templateLibrary.e(kv)).html() + "</li>";
                            });
                    ...
                    reply: function (t, useless, _this) { //TODO :
                        ...
                        location.href = "/html/pages/comm/comment.html?resourceId="+
                    ...
                    docSet: function (t) {
                        ...
                        //处理初始化时状态
                        s.docSetPlace.prepend(t.templateLibrary.g1).find("#set_daytime").on("vclick", function () {
                        ...
                        }).siblings("#set_night").on("vclick", function () {
                            ...
                            document.getElementsByTagName("head")[0].appendChild(oCss);
                        }).parent().siblings(".font_size_qh").find("#set_bigFont").on("tap", function () {
                            t.commonFn.readSchema("font", 0);
                            $("body").css("font-size", parseInt(localStorage.readSchema.split(",")[2]) * s.bigFont + "px");
                            $(this).attr("class", "font_size_click").siblings("div:eq(0),div:eq(1)").attr("class", "font_size_normal");
                        }).siblings("#set_font").on("tap", function () {
                            t.commonFn.readSchema("font", 1);
                            $("body").css("font-size", parseInt(localStorage.readSchema.split(",")[2]) + "px");
                            $(this).attr("class", "font_size_click").siblings("div:eq(0),div:eq(1)").attr("class", "font_size_normal");
                        }).siblings("#set_smallFont").on("tap", function () {
                            t.commonFn.readSchema("font", 2);
                            $("body").css("font-size", parseInt(localStorage.readSchema.split(",")[2]) * s.smallFont + "px");
                            $(this).attr("class", "font_size_click").siblings("div:eq(0),div:eq(1)").attr("class", "font_size_normal");
                        }).parent().parent().siblings("#docSetClose").on("tap", function () {
                            $(".doc_qh,.cover").remove();
                            if (s.floatClick) $("section").trigger("touchstart");
                            document.body.style.overflow = 'auto';
                        });
