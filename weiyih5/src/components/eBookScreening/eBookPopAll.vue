<template>
    ...
    <section class="al-twoFloorFilter" data-alcode-mod='404' data-alcode-item-selector="article">
        <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':index===0}" @click="typeClick(0,0)" data-type="0">全部</article>
        <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':index===1}" @click="typeClick(1,7)" data-type="7">病例</article>
        <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':index===2}" @click="typeClick(2,1)" data-type="1">视频</article>
        <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':index===3}" @click="typeClick(3,2)" data-type="2">文库</article>
        <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':index===4}" @click="typeClick(4,4)" data-type="4">话题</article>
    </section>
</section>
</template>
<script>
