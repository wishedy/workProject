<template>
    <section class="al-typeFilterMainMask" :class="{'active':mNavBarOp.topTabFlag&&mNavBarOp.indexPop===aPopIndex}">
        <section class="al-twoFloorFilter" data-alcode-mod='405' data-alcode-item-selector="article">
            <article class="al-oneFloorFilterItem EV-filterScene" :class="{'active':index===0}" @click="typeClick(0,aPopIndex===1?5:4)">智能排序</article>
            <article class="al-oneFloorFilterItem EV-filterScene" :class="{'active':index===1}" @click="typeClick(1,aPopIndex===1?2:1)">最新发布</article>
            <article class="al-oneFloorFilterItem EV-filterScene" :class="{'active':index===2}" @click="typeClick(2,aPopIndex===1?4:3)">最多浏览</article>
            <article class="al-oneFloorFilterItem EV-filterScene" :class="{'active':index===3}" @click="typeClick(3,aPopIndex===1?3:2)">最多评论</article>
        </section>
    </section>
</template>
<script>
