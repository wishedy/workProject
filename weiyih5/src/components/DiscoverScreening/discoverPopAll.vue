<template>
    <section v-if="aPopIndex===1" class="al-typeFilterMainMask"
        ...
        <section class="al-twoFloorFilter" data-alcode-mod='404' data-alcode-item-selector="article">
            <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':parseInt(typeVal)===0||parseInt(typeVal)===-1}" @click="typeClick(0,0)" data-type="0">全部</article>
            <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':parseInt(typeVal)===7}" @click="typeClick(1,7)" data-type="7">病例</article>
            <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':parseInt(typeVal)===1}" @click="typeClick(2,1)" data-type="1">视频</article>
            <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':parseInt(typeVal)===2}" @click="typeClick(3,2)" data-type="2">文库</article>
            <article class="al-oneFloorFilterItem EV-filterType" :class="{'active':parseInt(typeVal)===4}" @click="typeClick(4,4)" data-type="4">话题</article>
        </section>
    </section>
</template>
<script>
    /**
     * 功能描述：按专业/疾病/术式/类型的  "全部类型"筛选弹层
