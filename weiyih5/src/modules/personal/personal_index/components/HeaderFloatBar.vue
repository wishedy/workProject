<template>
    ...
    <header class="al-personalScrollHead al-personalHeadFixed" style="display: block">
        <h2>
            <a class="ev_backBtn scrollBack" href="javascript:history.back(-1);">
                <img src="//img50.allinmd.cn/pages/personal/arrow_back.png" alt="">
            </a>
            <span class="ev-name namecenter">{{name}}</span>
            <span class="al-personalShare icon-shareDeepBlue" v-show="hasAuth&&hasShare&&hasLogin"></span>
        </h2>
    </header>
</template>
