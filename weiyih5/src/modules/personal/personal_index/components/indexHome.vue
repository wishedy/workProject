<template>
    <section>
        <header-bar :isIndexHome="true" @isResource="isResource"></header-bar>
       <section @click="gotoInfo">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            tabChange(index){
              this.isResurce=index;
                if(index==1){
                    this.commCreatEvent({id:11255,browType:298});
                }else {
                    this.commCreatEvent({id:11256,browType:298});
                }
            },
            gotoInfo(){
                this.commCreatEvent({id:11262,browType:298});
                this.$router.push({
                    path:'Info'
                })
            },
        ...
        mounted(){
            this.getEvent({paramJson:JSON.stringify({customerId:localStorage.getItem('userId')})})
        },
        beforeMount(){
