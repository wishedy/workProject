<template>
    <section class="al-personalContent al-personalContribution" style="width: 100%;" data-role="contribution">
        <header class="al-personalContributionHeader ev-subNav" v-show="login">
        ...
        <section class="ev-list" data-alcode-mod="490" v-show="login">
            ...
            <section class="al-contentPartModule" v-for="(v,i) in dataList" v-show="!noImage" @click="commCreatEvent({id:11263,browType:298,locationId:v.customer_trends&&v.customer_trends.resourceId})">
...
<script>
    ...
    export default {
        ...
        methods:{
            ...mapActions(['changeAjax','commCreatEvent']),
            dataTime(time){
            ...
            propertyClick(item,index){
                ...
                this.commCreatEvent({id:11257,browType:298});
            ...
            switchList(v,i){
                ...
                if(this.flag == i) {
                    ...
                    this.commCreatEvent({id:num,browType:298})
                    this.initContribution(1);
                    this.flag = i;
                }
            },
            initContribution(clickFlag){
                ...
                axios({
                    ...
                    if(comm.hasResponseData(res.data)){
                        ...
                        if(t.pageIndex==1){
                            t.$emit('totalCount',result.totalCount)
                        }
