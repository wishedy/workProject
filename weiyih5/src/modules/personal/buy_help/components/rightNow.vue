<template>
    <section class="al-payHelp">
        ...
        <section class="al-payDetails-container">
            ...
            <p>因Apple支付服务在国外，需要时间验证等待，充值后没有显示请不要急于二次支付，请在24h内查看充值结果，偶尔可能会小概率出现支付验证延迟或失败等情况，如果遇到款项已支付但是余额未充值上的情况，我们会在24小时向苹果服务端反复确认你的订单支付状态。
            </p>
            <p v-show="appPort">
                仍有问题，
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                headerConfig: {
                    title: "通过苹果支付，为什么余额充值后没有立刻到账",  //  *标题项
                    share: {            // ..自定义分享项
                        onOff: true,
                        params: {
                            sceneType:101,
