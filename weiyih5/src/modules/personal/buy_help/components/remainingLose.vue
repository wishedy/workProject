<template>
    <section class="al-payHelp">
        ...
        <section class="al-payDetails-container">
            <h1 class="de-title">为什么更换手机后购买内容还在，而余额不见了？</h1>
            <p>目前IOS系统余额与其他系统余额独立存在，IOS系统充值的余额仅限IOS系统消费，无法更换系统使用，因此余额不互通，也无法跨系统查询.请使用原系统手机登录，余额即可正常显示。
            </p>
            <p v-show="appPort">
                仍有问题，
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                headerConfig: {
                    title: "为什么更换手机后购买内容还在，而余额不见了",  //  *标题项
                    share: {            // ..自定义分享项
                        onOff: true,
                        params: {
                            sceneType:101,
                            customerId:TempCache.getItem('userId') || '',
                            questionTitle:'为什么更换手机后购买内容还在，而余额不见了',
                            questionType:'4'
                        },
                        authority: 1
                    },
        ...
        mounted() {
            ...
            this.headerConfig.title = '为什么更换手机后购买内容还在，而余额不见了';
            document.title='为什么更换手机后购买内容还在，而余额不见了';
            this.checkApp();
            if (this.appPort) {
                //3.7安卓没写。ios写了，先注释
