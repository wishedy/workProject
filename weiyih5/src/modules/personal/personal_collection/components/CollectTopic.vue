						...
						if(comm.hasResponseData(res)){
							...
							if(dataList&&dataList.length){
								...
								for(var i=0,l = dataList.length;i<l;i++){
									json={};
									let e = dataList[i];
									let isValidRes = t.isValidResource({isValid:e.resource_valid.resourceValid,itemTitle:e.cms_topic.topicName,itemUrl:e.cms_topic.webStoragePath});
									json.currentScoreNum = (e.resource_valid.resourceValid==0||e.resource_valid.resourceValid==2||e.resource_valid.resourceValid==3?0:e.cms_topic.currentScoreNum);
									json.currentStarLevel = e.cms_topic.currentStarLevel;
									json.itemType = 4;
									...
									json.browseNum = e.cms_topic.browseNum;
									json.commentNum = e.cms_topic.reviewNum;
									json.picNum = (e.resource_valid.resourceValid==0||e.resource_valid.resourceValid==2||e.resource_valid.resourceValid==3?0:e.cms_topic_attachment.topicAttUrl?1:0);
									json.picUrl = e.cms_topic_attachment.topicAttUrl;
