<template>
	<section>
		<section class="al-noLoginTips ev-noLogin" style="" v-if="!hasLogin">
			<figure><img src="./../assets/no_login.png" alt=""></figure>
		</section>
		...
		<section class="ev-list al-comment" data-alcode-mod="475" v-if="hasLogin">
...
<script>
	...
	export default {
		...
		mounted() {
			this.hasLogin = localStorage.getItem('userId')?true:false;
			if(this.hasLogin){
				this.getComment();
			}
