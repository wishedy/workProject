<template>
    ...
    <section class="alLogin">
        <section class="alLoginWidth">
            ...
            <figure class="alLoginLogo"><img src="//img50.allinmd.cn/new-login/logo.png" /> </figure>
            ...
            <section class="alLoginBtn disabled">立即进入</section>
...
<script type="text/ecmascript-6">
    ...
    export default{
        ...
        methods:{
            topShowPageError(str, fn) {
                let topErrorDom = '<section class="topShowError"><i></i>' + str + '</section>';
        ...
        mounted(){
            ...
            function allinLoginPageInit(){
                ...
                function loginSubmit(){
                    ...
                    type = comm.checkAccountType(email);
                    var param = {
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if(!result.responseStatus){         // 登录失败
                                t.topShowPageError(result.responseMessage);
                            }else{
                                //绑定微信操作
                                if(comm.isWeiXin()){
